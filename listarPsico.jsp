<%-- 
    Document   : listar
    Created on : 14/11/2020, 15:11:57
    Author     : usuario
--%>
        ...
        <script>
            window.onload = function() {
                ...
                data.push({id: 1, values: {"classificacao":"<%= c.getClassificacao() %>","inscricao":"<%= c.getNuminscricao() %>",
                        "nome":"<%= c.getNome() %>","bairro":"<%= c.getBairro() %>","cep":"<%= c.getCep() %>",
                        "rg":"<%= c.getRg() %>","telfixo":"<%= c.getTelfixo() %>","telcel":"<%= c.getTelcel() %>","telrec":"<%= c.getTelrecado() %>",
                        "mae":"<%= c.getNomemae() %>","pai":"<%= c.getNomepai() %>", "pont":<%= c.getPontuacao() %>}});
                <%
                    }
                %>
